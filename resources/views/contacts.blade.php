    ...
    <div class="row">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item disabled"><a class="text-decoration-none fw-light text-secondary " href="{{ route('contacts.index')}}">Оплата</a></li>
            </ol>
        </nav>
        ...
        <div class="d-flex justify-content-between">
            ...
            <h3>Оплата</h3>
            <button class="btn btn-primary btn-danger b-0 rounded-0 fw-bold" style="padding: 0.5% 10% 0.5% 10%;">Оплатить</button>
        </div>
        <h5>Банки партнеры</h5>

    </div>
</div>
<div class="container mt-5 bg-light p-4 lg">
    <div class="row">
        <div class="col-sm col-md-2 mb-1">
            <img src="..." alt="..">
        </div>
        <div class="col-sm col-md-2 mb-1">
            <img src="" alt="..">
